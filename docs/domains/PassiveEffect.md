...
PassiveEffect ドメインは、プレイヤーに影響を与える一時的・持続的な効果を管理します。バフ・デバフ、ステータス効果、環境効果など、戦闘パラメータやゲームプレイに影響を与える全ての効果を統一的に扱います。
...
PassiveEffect ドメインは、ゲームの戦術性と深さを提供する重要なシステムです。他のドメインと連携することで、豊富なゲームプレイ体験を実現します。